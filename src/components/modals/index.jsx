  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:12 }}>
        ...
        <div><label className="fl">status</label><select value={draft.status} onChange={e => set("status",e.target.value)} style={{ width:"100%", marginTop:4, boxSizing:"border-box" }}><option value="planning">planning</option><option value="in_progress">in progress</option><option value="review">review</option><option value="on_hold">on hold</option><option value="delivered">delivered</option></select></div>
      </div>
