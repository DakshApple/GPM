  ...
  return (
    <aside style={{ width:220, flexShrink:0, display:"flex", flexDirection:"column", borderRight:"1px solid var(--border)", background:"var(--surface)" }}>
      <div style={{ padding:16, display:"flex", alignItems:"center", gap:8, borderBottom:"1px solid var(--border)" }}>
        <div className="font-display" style={{ width:28, height:28, borderRadius:6, display:"flex", alignItems:"center", justifyContent:"center", background:"var(--amber)", color:"#1A0F00", fontWeight:700, fontSize:13 }}>G</div>
        <div>
          <div className="font-display" style={{ fontWeight:600, fontSize:13, lineHeight:1.2 }}>GPM</div>
          <div className="font-mono" style={{ fontSize:9, color:"var(--text-3)" }}>genartml project manager</div>
        </div>
      </div>
